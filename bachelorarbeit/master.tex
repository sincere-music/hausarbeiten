...
\title{Go, song of mine}
\subtitle{
Edward Elgars Chorlyrik \\
im Kontext seiner Stilentwicklung und Weltanschauung
}
...
die Chorleitung inne, und einige seiner frühen Kompositionen sind
...
den er Arrangements verfasste, kamen mit Sicherheit regelmäßig neue
...
\begin{itemize}
 ...
 von Musik von Mozart resp. Beethoven,\footnote{Ediert in
 \cite[Anhang~A, S.\,221–64]{ece12}.} lässt sich beobachten, wie seine
...
\textit{a-capella}-Lieder gebrochen wird, deutet an, dass diese Gattung
vielleicht einen besonderen Platz in seinem Leben einnahm.
...
\begin{itemize}
 ...
 Tennysons Gedicht \textit{The Lotos-Eaters}, aus dem Elgar hier die erste
 Strophe des \engquote{Choric Song} vertont,
 ist selbst durch eine Spanien-Reise angeregt\cite[S.\,122]{ece13}.
 ...
 zitiert in \cite[S.\,169]{atkins}}, so ist die zweite Hälfte dieses Spruchs
...
stand\cite[S.\,443]{moore} und auch, dass es mehrfach Einfluss auf Elgars
...
Liebestod anklingen lässt.\cite[S.\,553]{moore}  Das ist zwar zunächst
...
Geplagten unterlegt, erhält eine Schärfe durch das
\textit{staccato} auf der ersten Note und Nachdruck durch einen Akzent
auf der Vergeblichkeit des Rufens.  Auch der Höhepunkt mit der
...
Es ist bereits beschrieben worden, dass Elgars Chorlieder opp.\,71–73,
...
seines Grundbefindens gewesen, und wie sich nun ein abnehmendes Interesse
...
der Form und weitgehend eintönigen Bewegung.  Die sehr geringen Umfänge
...
Eins der Werke, die das Schweigen der ’20er Jahre unterbrechen, entstand
...
Oberbegriff für Weihnachtslieder aller Arten geworden.  Demgegenüber erwachte
...
\begin{itemize}
 \item Die ersten drei Strophen werden unbegleitet und einstimmig
 vorgetragen.  Damit verwirklicht Elgar noch größere Eigenständigkeit der
...
Horizont des Komponisten, und von der Vielzahl der Anregungen
aus dem literarisch interessierten Umfeld; aber vor allem war es ihm
...
Naivität als unwiederbringlich verloren erscheint.  Desto rätselhafter
